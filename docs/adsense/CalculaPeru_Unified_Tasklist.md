...
| **BUG-06** | UI / Truncamiento | En resoluciones intermedias o montos elevados, el resultado monetario principal en algunas calculadoras podía contraerse con puntos suspensivos ("S/ 2,177..."). | Definida la regla de diseño y clases CSS con números tabulares (`tabular-nums font-mono break-words`) y escalado tipográfico adaptativo para garantizar que ningún importe monetario se trunque jamás. | **En Incorporación Visual** |
| **BUG-07** | UI / Sobrecarga Visual | La portada actual incluye una fotografía de Machu Picchu detrás del hero y tarjetas de calculadoras con imágenes genéricas (monedas, calculadoras de stock) que alargan el scroll innecesariamente. | Diseñadas las propuestas de rediseño A y B: reemplazo por superficies limpias, buscador protagónico y directorio estructurado de 4 categorías compactas. | **Propuestas Listas para Elección** |
